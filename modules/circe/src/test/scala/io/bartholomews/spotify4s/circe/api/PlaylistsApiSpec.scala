...
//import io.bartholomews.spotify4s.OldServerBehaviours
//import io.bartholomews.spotify4s.DiffDerivations.matchTo
//import io.bartholomews.spotify4s.circe.{CirceWordSpec, OldServerBehaviours}
//import io.bartholomews.spotify4s.core.client.ClientData.{sampleClient, sampleNonRefreshableToken}
//import io.bartholomews.spotify4s.core.api.SpotifyApi.SpotifyUris
//import io.bartholomews.spotify4s.core.entities.{CollectionLink, IsoCountry, Page, PublicUser, SimplePlaylist, SnapshotId, SpotifyId, SpotifyImage, SpotifyResourceUrl, SpotifyUri, SpotifyUserId}
//import io.circe
//import io.circe.{Decoder, HCursor}
//import org.scalatest.matchers.should.Matchers
//import sttp.client.{Identity, Response, UriContext}
//import sttp.model.{StatusCode, Uri}
//
//class PlaylistsApiSpec extends CirceWordSpec with OldServerBehaviours with Matchers {
//  import cats.implicits._
//  import eu.timepit.refined.auto._
//
//  // TODO: find a way to module-test with different codecs
...
//
//      behave like clientReceivingUnexpectedResponse[Nothing, Unit](endpointRequest, request, decodingBody = false)
//
...
//      def request: SttpResponse[circe.Error, Page[SimplePlaylist]] =
//        sampleClient.playlists.getUserPlaylists[circe.Error](
...
//
//      def request: SttpResponse[circe.Error, SnapshotId] = {
//        sampleClient.playlists.addTracksToPlaylist[circe.Error](
//          playlistId = SpotifyId("2LZYIzBoCXAdx8buWmUwQe"),
...
//      def request =
//        sampleClient.playlists.getPlaylist[circe.Error](playlistId = SpotifyId("3cEYpjA9oz9GiPac4AsH4n"))
//
//      behave like clientReceivingUnexpectedResponse(endpoint, request)
//
//      def stub: StubMapping =
...
//      }
//
//      def request: SttpResponse[circe.Error, PartialPlaylist] =
//        sampleClient.playlists.getPlaylistFields[io.circe.Error, PartialPlaylist](
...
//      def request = sampleClient.playlists.getPlaylist(
//        customPlaylistId,
//        market = None
//      )
//
...
//      def request = sampleClient.playlists.createPlaylist(
