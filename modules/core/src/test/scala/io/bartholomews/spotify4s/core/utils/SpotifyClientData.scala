...
import io.bartholomews.spotify4s.core.entities.SpotifyId.{SpotifyTrackId, SpotifyUserId}
...
object SpotifyClientData {
  ...
  val sampleSpotifyTrackId: SpotifyTrackId = SpotifyTrackId("SAMPLE_SPOTIFY_ID")
